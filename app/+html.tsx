...
// Full-weight .ttf files (used natively via constants/typography.ts's
// `fontAssets`) plus their subsetted .woff2 counterparts (generated by
// glyphhanger + fonttools, stripped to just the ASCII range this app
// actually uses — ~56KB each Down to ~10KB each). Both are required here
// so the web bundler resolves each to a public asset URL: woff2 is the
// primary source (smaller → faster to fetch), ttf is listed second as a
// fallback for the small sliver of browsers without woff2 support — the
// browser tries sources in order and stops at the first it can use, so
// modern browsers never touch the ttf at all.
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraRegularWoff2 = require('../assets/fonts/Sora-Regular-subset.woff2');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraRegular = require('../assets/fonts/Sora-Regular.ttf');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraMediumWoff2 = require('../assets/fonts/Sora-Medium-subset.woff2');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraMedium = require('../assets/fonts/Sora-Medium.ttf');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraSemiBoldWoff2 = require('../assets/fonts/Sora-SemiBold-subset.woff2');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraSemiBold = require('../assets/fonts/Sora-SemiBold.ttf');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraBoldWoff2 = require('../assets/fonts/Sora-Bold-subset.woff2');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraBold = require('../assets/fonts/Sora-Bold.ttf');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const soraExtraBoldWoff2 = require('../assets/fonts/Sora-ExtraBold-subset.woff2');
// eslint-disable-next-line @typescript-eslint/no-var-requires
